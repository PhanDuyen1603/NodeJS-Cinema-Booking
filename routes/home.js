...
router.get('/filmSearch', async function (req, res) {
    ...
    const params = {
        where: {
            ...
            film_Public: true,
             //sửa lại ilike cho phân biệt chữ hoa thường
            film_Name: {
                [Op.iLike]: `%${NameFilm}%`
            }
    ...
    console.log(params);
    const searchNameFilmPublic = await Film.findAll(params);
    ...
    //console.log(searchNameFilmPublic);
    //console.log(searchNameFilmNoPublic);
